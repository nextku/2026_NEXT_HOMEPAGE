...
export const ABOUT_HISTORY = [
  {
    ...
    CONTENT: [
      ...
      ['"Sume" 글로벌 액셀러레이터 Founders Inc 프리시드 유치 + 베이스/EO 투자', 0],
      ["구글, 토스, 무신사, 우아한 형제들 등 주요 테크기업 개발자, PM, 마케터 다수 배출", 0],
      ["Travolo, lucktime 등의 서비스 출시 및 운영", 0],
      [
        "스타트업 익스프레스, 정운오 학생창업경진대회 등 창업경진대회 다수 수상 (찾아검진, Travolo)",
        0,
      ],
    ],
  },
  ...
  },
  {
    ...
    CONTENT: [
      [
        "비전공자 대상 프로그래밍 교육 동아리로서 2013년도 서울대 1기 시범 운영 후, 서울권 주요 대학으로 확장",
        0,
      ],
    ],
  },
