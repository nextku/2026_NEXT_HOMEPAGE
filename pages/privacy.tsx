 ...
 * 개인정보처리방침.
 *
 * 구글 OAuth 동의 화면에 링크로 요구되는 문서이기도 하지만, 그 전에 실제로
 * 무엇을 받아 어디에 두는지 적는 것이 목적이다. 아래 내용은 코드에서 확인한
 * 실제 수집 항목을 그대로 옮긴 것이다.
 *   지원 폼   components/s3upload      이름 · 학번 · 이메일 · 전화번호 · 파일
 *   로그인    lib/supabase             구글 계정 이메일 · 이름, 기수 · 학과
    ...
    <>
      ...
      <S.Page>
        <S.Wrap>
          ...
          <S.Section>
            <p>
              고려대학교 소프트웨어 창업학회 NEXT(이하 &lsquo;학회&rsquo;)는 학회
              지원과 학회원 서비스 제공에 필요한 최소한의 개인정보만 수집합니다.
              이 문서는 학회가 수집하는 항목과 그 이용 목적, 보관 기간을
              설명합니다.
            </p>
          </S.Section>
          ...
          <S.Section>
            ...
            <p>
              학회는 위 항목 외에 <b>주민등록번호, 계좌번호, 사상·신념, 건강
              정보 등 민감정보를 수집하지 않습니다.</b>
            </p>
          </S.Section>

          <S.Section>
            <h2>2. 로그인 시 구글에서 받는 정보</h2>
            <p>
              구글 계정으로 로그인하면 학회는 구글로부터{" "}
              <b>이메일 주소와 이름</b>만 전달받습니다. 구글 계정의 비밀번호는
              학회에 전달되지 않으며 학회가 저장하지도 않습니다.
            </p>
            <p>
              전달받은 정보는 학회원 여부를 확인하고 학회원 전용 화면에 접근
          ...
          <S.Section>
            ...
            <ul>
              <li>
                Supabase — 회원 정보 저장 (데이터 보관 위치: 대한민국 서울)
              </li>
              <li>Amazon Web Services — 지원서 파일 보관</li>
              <li>Vercel — 웹사이트 호스팅</li>
              <li>Google — 로그인 인증, 방문 통계(Google Analytics)</li>
            </ul>
          </S.Section>
          ...
          <S.Section>
            <h2>4. 제3자 제공</h2>
            <p>
              학회는 이용자의 개인정보를 제3자에게 제공하지 않습니다. 다만 법령에
              따라 수사기관 등이 적법한 절차로 요청하는 경우에는 예외로 합니다.
            </p>
          </S.Section>
          ...
          <S.Section>
            <h2>5. 이용자의 권리</h2>
            <p>
              이용자는 언제든지 자신의 개인정보에 대해 <b>열람, 정정, 삭제,
              처리 정지</b>를 요청할 수 있습니다. 아래 연락처로 요청하면 지체
              없이 처리합니다.
            </p>
            <p>
