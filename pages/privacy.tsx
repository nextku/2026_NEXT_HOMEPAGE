      ...
      <S.Page>
        <S.Wrap>
          ...
          <S.Section>
            ...
            <S.Table>
              <table>
                ...
                <tbody>
                  ...
                  {/*
                     방문 기록과 이용 기록을 한 줄로 합쳤다.

                     둘로 나눠 항목을 잘게 적었더니 실제보다 훨씬 많이 들여다보는
                     것처럼 읽혔다. 게다가 '접속 기기·브라우저 정보' 는 우리가
                     담지 않는 것이었다 — events 표에는 기기 칸이 없다. 안 하는
                     일을 적어두면 그것도 틀린 고지다.
                  */}
                  <tr>
                    <td>사이트 이용 기록</td>
            ...
            <p>
              이용 기록은 브라우저가 스스로 만든 임의의 문자열로만 묶이며
              이름·이메일 등 개인을 알아볼 수 있는 정보와 연결되지 않습니다.
            </p>
            {/*
               "IP 주소는 저장하지 않습니다" 를 걷어냈다. 우리 기록에는 담지
               않지만, 로그인 서비스가 계정 도용을 추적하려고 접속 주소를
               남긴다. 없다고 단정한 것이 있으면 그것이 가장 나쁜 고지다.
            */}
            <p>
              로그인 서비스는 계정 도용을 막기 위해 접속 기록에 IP 주소를
              남깁니다. 이 기록은 보안 확인 외의 목적으로 쓰지 않으며, 위의
              이용 통계와도 연결하지 않습니다.
            </p>
          </S.Section>
