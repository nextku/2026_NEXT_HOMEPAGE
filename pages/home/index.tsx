  ...
  return (
    <S.PageShell>
      ...
      <S.Container>
        ...
        <Sticky></Sticky>
        <S.Section2>
          <S.TextWrapper data-aos="fade">
            <span>
              <b>What We Do</b>
            </span>
          </S.TextWrapper>
          <S.LottieContainer>
            <S.LottieWrapper data-aos="zoom-in" data-aos-delay="100">
              <SessionLottie />
              <h2>Session</h2>
              <p>필수 기술 스택 습득</p>
            </S.LottieWrapper>
            <S.LottieWrapper data-aos="zoom-in" data-aos-delay="300">
              <ProjectLottie />
              <h2>Project</h2>
              <p>팀별 실전 서비스 개발</p>
            </S.LottieWrapper>
            <S.LottieWrapper data-aos="zoom-in" data-aos-delay="500">
              <DemodayLottie />
              <h2>Demoday</h2>
              <p>서비스 검증 및 평가</p>
            </S.LottieWrapper>
          ...
          >
            <S.MoreBtn onClick={() => router.push("activities")}>
