                ...
                {modalPage == 1 && (
                  <S.InfoModal>
                    ...
                    <S.InfoSection>
                      <h3>학회비 환불 규정</h3>
                      <p>
                        NEXT는 등록 여부 확인 과정에서 등록 의사를 최종적으로
                        밝힌 시점부터 해당 기수의 정식 학회원으로 등록됩니다.
                      </p>
                      <p>
                        개인 사정으로 활동을 취소하는 경우, <b>OT 진행 전</b>에
                        탈퇴 의사를 밝힌 경우에 한하여 학회비 전액 환불이
                        가능합니다.
                      </p>
                      <p>
                        OT 이후에는 해당 기수의 활동이 시작된 것으로 간주하며,
                        개인 사정에 의한 중도 탈퇴 시 학회비는 원칙적으로
                        환불되지 않습니다.
                      </p>
                    </S.InfoSection>
